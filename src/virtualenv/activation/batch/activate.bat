...
@echo DEBUG_BEFORE_ESCAPE: "%VIRTUAL_ENV_PROMPT%"
@set "VIRTUAL_ENV_PROMPT=%VIRTUAL_ENV_PROMPT:&=^^&%"
@echo DEBUG_AFTER_ESCAPE: "%VIRTUAL_ENV_PROMPT%"
@echo DEBUG_PROMPT_SET: "(%VIRTUAL_ENV_PROMPT%) %PROMPT%"
@echo DEBUG_PROMPT_ENV: "%PROMPT%"
